...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'search_location', (
            ...
            ('travel_distance', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'search', ['Location'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'search_location')
    ...
    models = {
        ...
        u'search.location': {
            ...
            'travel_distance': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
